...
st.markdown("""
<style>
    .main { background-color: #f8f9fb; padding: 2rem; border-radius: 10px; }
...
4. IF NOT ANSWERED: Give practical fix + alternative (alternative must be realistic — e.g., fire-rate wall instead of moving building)
